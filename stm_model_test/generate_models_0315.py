...
Configuration().solver_configuration = {"Threads": 16,}
...
for name, result in imat_results.items():
    ...
    flux_df.to_csv(
        f"/home/gmvaz/2026_GEMs/stm_model_test/run_031526/fluxes/{name}_imat_fluxes.csv",
        index=False
    )
...
for method, models in model_sets.items():
    for name, model in models.items():
        save_json_model(
            model,
            f"/home/gmvaz/2026_GEMs/stm_model_test/run_031526/context_models/{name}_{method}.json"
        )